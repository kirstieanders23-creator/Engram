        ...
        <View style={styles.plansContainer}>
          ...
          >
            ...
            <Text style={[styles.trial, { color: colors.textSecondary }]}>
              7-day free trial, then ${SUBSCRIPTION_PLANS.PREMIUM_YEARLY.price}
              /year
            </Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={[styles.trial, { color: colors.textSecondary }]}>
              7-day free trial, then ${SUBSCRIPTION_PLANS.PREMIUM_MONTHLY.price}
              /month
            </Text>
          </TouchableOpacity>
        </View>
...
const getFeatureDescription = (feature) => {
  const descriptions = {
    quick_lookup:
      "Instantly identify products and check if they're dishwasher safe with Quick Lookup Camera",
    upgrade_finder:
      "Find and compare product upgrades with intelligent scoring",
