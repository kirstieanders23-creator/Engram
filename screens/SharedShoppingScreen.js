          ...
          <View style={styles.itemDetails}>
            ...
            {claimedByOther && (
              <View style={styles.claimedBadge}>
                ...
                />
                <Text
                  style={[styles.claimedText, { color: colors.secondaryText }]}
                >
      ...
      >
        ...
        <View style={styles.setupContainer}>
          ...
          <Text style={[styles.setupTitle, { color: colors.text }]}>
            Setup Household First
          </Text>
          <Text
            style={[styles.setupDescription, { color: colors.secondaryText }]}
          >
            ...
            return (
              <View key={member.id} style={styles.statItem}>
                <View style={styles.statWithDot}>
                  <View
                    style={[styles.statDot, { backgroundColor: member.color }]}
                  />
                  <Text style={[styles.statNumber, { color: colors.text }]}>
                    {memberStats.claimed}
                  </Text>
