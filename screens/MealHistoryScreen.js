...
export const MealHistoryScreen = ({ navigation }) => {
  ...
  const handleDeleteMeal = (meal) => {
    Alert.alert("Delete Meal", `Remove "${meal.name}" from history?`, [
      ...
      >
        <View style={styles.mealHeader}>
          ...
          {meal.rating ? (
            ...
            >
              <Text
                style={[styles.rateButtonText, { color: colors.secondaryText }]}
              >
                Rate
              </Text>
            </TouchableOpacity>
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              viewMode === "suggestions" && { color: colors.primary },
              { color: colors.secondaryText },
            ]}
          >
            Suggestions
        ...
        >
          <Text
            style={[
              styles.tabText,
              viewMode === "favorites" && { color: colors.primary },
              { color: colors.secondaryText },
            ]}
          >
            Favorites
        ...
        >
          <Text
            style={[
              styles.tabText,
              viewMode === "all" && { color: colors.primary },
              { color: colors.secondaryText },
            ]}
          >
            All
          ...
          <View style={[styles.alertCard, { backgroundColor: "#FFE66D" }]}>
            ...
            <View style={styles.alertText}>
              ...
              <Text style={styles.alertDescription}>
                {forgottenFavorites.length} loved{" "}
                {forgottenFavorites.length === 1 ? "meal" : "meals"} you haven't
                made in a while
              </Text>
            </View>
          </View>
        ...
        <View style={styles.section}>
          {displayedMeals.length > 0 ? (
            displayedMeals.map((meal) =>
              renderMealCard(meal, viewMode === "suggestions"),
            )
          ) : meals.length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              >
                Meals you add to your weekly plan will appear here with ratings
                and suggestions
              </Text>
              <TouchableOpacity
                style={[
            ...
            <View style={styles.emptyContainer}>
              ...
              />
              <Text style={[styles.emptyTitle, { color: colors.text }]}>
                No {viewMode === "favorites" ? "Favorites" : "Results"}
              </Text>
              <Text
                style={[
                  styles.emptyDescription,
              ...
              >
                {viewMode === "favorites"
                  ? "Rate meals 4-5 stars to add them here"
