  ...
  const handleCategorySelect = (categoryName) => {
    ...
    if (template) {
      const updatedData = {
        ...
        isDishwasherSafe:
          formData.isDishwasherSafe ||
          template.commonFields.isDishwasherSafe ||
          "",
        careInstructions:
          formData.careInstructions ||
          template.commonFields.careInstructions ||
          "",
        cleaningTips:
          formData.cleaningTips || template.commonFields.cleaningTips || "",
      };
      ...
      >
        <ScrollView contentContainerStyle={styles.modalContent}>
            ...
            >
              {getAllCategories().map(({ name, icon }) => (
                ...
                >
                  <Text
                    style={{
                      color: formData.category === name ? "#fff" : colors.text,
                    }}
                  >
                    {icon} {name}
                  </Text>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setFormData({ ...formData, careInstructions: text })
            }
            multiline
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setFormData({ ...formData, isDishwasherSafe: text })
            }
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setFormData({ ...formData, manualUrl: text })
            }
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setFormData({ ...formData, cleaningTips: text })
            }
            multiline
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setFormData({ ...formData, usageNotes: text })
            }
            multiline
          />
...
export const ProductsScreen = ({ navigation }) => {
  ...
  const rooms = [
    "All",
    ...new Set(products.filter((p) => p.room).map((p) => p.room)),
  ];
  ...
  const handleScan = async () => {
    try {
      ...
      if (match) {
        ...
        Alert.alert(
          "Product Added",
          "Product added to inventory automatically.",
        );
      }
    } catch (e) {
  ...
  const handleStartBarcode = async () => {
    try {
      ...
      const { status } =
        await BarcodeScanner.BarCodeScanner.requestPermissionsAsync();
      if (status !== "granted") {
        Alert.alert(
          "Permission required",
    ...
    return (
      ...
      >
        ...
        <View style={styles.productOverlay}>
          ...
          {warrantyStatus && (
            <View
              style={[styles.warrantyBadge, { backgroundColor: colors.accent }]}
            >
    ...
    >
          ...
          {rooms.map((room) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor:
                    selectedRoom === room ? colors.primary : colors.card,
                  borderColor:
                    selectedRoom === room ? colors.primary : colors.border,
                },
              ]}
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          numColumns={2}
          columnWrapperStyle={
            filteredProducts.length > 0 ? styles.gridRow : null
          }
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyTitle, { color: colors.text }]}>
                Your Home Inventory Awaits
              </Text>
              <Text
                style={[styles.emptySubtitle, { color: colors.textSecondary }]}
              >
                Start building your home inventory by adding products or
                scanning items
              </Text>
              <TouchableOpacity
      ...
      {barcodeVisible && (
        ...
        >
          <SafeAreaView
            style={[styles.barcodeContainer, { backgroundColor: "#000000aa" }]}
          >
            <View style={styles.barcodeInner}>
              <Text style={[styles.barcodeTitle, { color: "#fff" }]}>
                Scan Barcode
              </Text>
