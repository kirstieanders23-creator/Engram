...
const SettingsScreen = ({ _navigation }) => {
  ...
  const [quickAddPrefs, setQuickAddPrefs] = React.useState({
    defaultRoom: "",
    alwaysPrompt: true,
  });
  ...
  React.useEffect(() => {
    const loadSettings = async () => {
      try {
        const { areNotificationsEnabled } = await import(
          "./utils/notifications"
        );
          ...
          [
            ...
            },
            {
              ...
              onPress: async () => {
                ...
                if (!granted) {
                  alert(
                    "Notification permissions denied. Please enable in your device settings.",
                  );
                  return;
                }
    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          >
            <TouchableOpacity
              onPress={() => {
                // Show room picker
                Alert.alert("Select Default Room", "", [
                  ...rooms.map((room) => ({
                    text: room,
                    onPress: () =>
                      saveQuickAddPrefs({
                  ...
                  })),
                  {
                    text: "None",
                    onPress: () =>
                      saveQuickAddPrefs({ ...quickAddPrefs, defaultRoom: "" }),
                  },
          ...
          >
            <TouchableOpacity
              onPress={() =>
                saveQuickAddPrefs({
                  ...quickAddPrefs,
                  alwaysPrompt: !quickAddPrefs.alwaysPrompt,
                })
              }
            ...
            >
              <View
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: quickAddPrefs.alwaysPrompt
                    ? colors.accent
                    : colors.border,
              ...
              >
                <View
                  style={{
                    ...
                    borderRadius: 8,
                    backgroundColor: "#fff",
                    marginLeft: quickAddPrefs.alwaysPrompt ? 14 : 2,
                  }}
                />
              </View>
            </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[
            styles.button,
            { backgroundColor: colors.secondary || "#555", marginTop: 10 },
          ]}
